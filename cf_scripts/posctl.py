...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 14 18:28:24 2018
...
#                cf.param.set_value('posCtlPid.xKp','{:.2f}'.format(2))
#                cf.param.set_value('posCtlPid.xKi','{:.2f}'.format(0.001))
#                cf.param.set_value('posCtlPid.xKd','{:.2f}'.format(0.0))
#                cf.param.set_value('posCtlPid.yKp','{:.2f}'.format(2))
#                cf.param.set_value('posCtlPid.yKi','{:.2f}'.format(0.001))
#                cf.param.set_value('posCtlPid.yKd','{:.2f}'.format(0.0))
#                break
        #time.sleep(1)
        i = y
        while True:
